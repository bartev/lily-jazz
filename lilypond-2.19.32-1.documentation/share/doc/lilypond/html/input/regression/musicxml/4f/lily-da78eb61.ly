...
\header {
    texidoc = "Compound time signatures with 
...
PartPOneVoiceOne =  \relative b' {
    \clef "treble" \key c \major \compoundMeter #'((3 8) (2 8) (3 4)) b8
    [ b8 b8 ] b8 [ b8 ] b4 b4 b4 | % 2
    \compoundMeter #'((5 2) (1 8)) a\breve a2 a8 \bar "|."
    }
