...
PartPOneVoiceOneLyricsOne =  \lyricmode { "ferm." "normal ferm." "angled
    ferm." "square ferm." "inv.ferm." "arp." "non-arp." "acc.mark"
    "acc." "str.-acc." "stacc." "ten." "det.-leg." "stacc.ss" "spicc."
    scoop plop doit falloff breath "caes." stress "unstr." "tr." turn
    "del.turn" "inv.turn" shake wavy -- wavy -- line "mord." "inv.mord."
    "schl." "trem." "turn+acc." "turn+acc.(ab.+bel./rel to turn)"
    "up-b." "down-b." "harm." "nat.harm." "art.harm." "nat.h./base"
    "nat.h./touching" "nat.h./sounding" "open-str." "thumb-pos." "empty
    fing." "fing.1" "fing.2" "fing.3" "fing.4" "fing.5" "fing.sth."
    "mult.fing." "empty pluck" "pluck a" "dbl.tng." "trpl.tng." stopped
    "snp.pizz." "empty fret" "fret0" "empty str." "str. 5" hammer -- on
    pull -- off bend "b.3 with-bar" "pre-b. -0.5" "b. release 3.5" tap
    "tap T" heel toe "fingern." f ppp sfp "Oth.dyn." "both above"
    "ab./bel./bel." }
