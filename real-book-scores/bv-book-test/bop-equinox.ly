...
composer = #"'Trane"
meter = #""
copyright-equinox = #"Coltrane's Sound"

realBookTitle-equinox = \markup {
  \score {
    {
...
bop-equinox = \bookpart {
  \tocItem \markup "Equinox"
  \header {
    title = \realBookTitle-equinox
    tagline = ##f
    copyright = \copyright-equinox
  }
  \score {
    <<
