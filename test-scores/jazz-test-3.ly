...
\score {
  ...
  >>
  \header { piece = \markup { \fontsize #3 \sans "Beginning of a Bill Evans Solo Transcription Time Remembered" } }
  \layout { indent = 0 }
  \midi { \tempo 4 = 140 }
}

%\markup { \override #'(font-name . "LilyJAZZ Text") "(Example taken from Frank Sikoraâs âNeue Jazz-Harmonielehreâ)" }
\markup { \sans "(Example taken from Frank Sikoraâs âNeue Jazz-Harmonielehreâ, p. 264)" }