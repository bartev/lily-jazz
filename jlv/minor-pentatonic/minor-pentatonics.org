...
C minor pentatonic has same notes as the E$\flat$ major pentatonic (relative major)

The blues scale is like the minor pentatonic with an added "blues" tone ($\sharp$ 4)
...
* Triplet 3rds
#+begin_src lilypond :file triplet-thirds.pdf
\score {
  \new StaffGroup
  <<
    \new Staff {
