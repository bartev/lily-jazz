...
title = #"Lester Leaps In - Phrases (Scheme Version)"
...
%% This function takes:
%% - fromPitch: original pitch (e.g., bes)
%% - toPitch: target pitch (e.g., c)
%% - keyMusic: key signature as music (e.g., #{ \key c \major #})
%% - keyLabel: string label for the key (e.g., "C")
%% - chords: the chord progression
%% - melody: the melody line
...
%%%%%%%%%%%%%%%%%%%% Generate all 12 keys using the function
